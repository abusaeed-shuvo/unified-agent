...
- **DNS rebinding IS mitigated via IP pinning** - the resolved IP is used for the connection, eliminating the TOCTOU window
- Redirects handled manually with SSRF re-validation and IP pinning on each hop
